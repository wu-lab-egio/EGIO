...
echo "summarize reciprocal blast"
...
python __EGIO.py --orthog $ortholog --blastn extrainfo/blastn_mapping.tab --species1 $species1 --species2 $species2 --isocom1 extrainfo/$species1.tran --cdscom1 extrainfo/$species1.exon --isocom2 extrainfo/$species2.tran --cdscom2 extrainfo/$species2.exon --identhres $identity --coverthres $coverage --match $match --mismatch $mismatch --gap $gap --pnum $pnum
###=======================================
